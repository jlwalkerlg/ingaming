...
<div class="container hide-overflow mt-nav">
    <h1 class="mt-nav">Add new game</h1>

    <form action="<?= url('/admin/games') ?>" method="POST" enctype="multipart/form-data" class="mb-5">
        <?= CSRF::input() ?>

        <!-- Title -->
        <div class="mb-4">
            <label for="title" class="form-label">Title</label>
            <input type="text" name="title" id="title" class="form-input form-input-block" placeholder="Title" value="<?= h(old('title')) ?>">
        ...
        <div class="mb-4">
            ...
            <textarea id="blurb" name="blurb" id="blurb" rows="8" class="form-input form-input-area form-input-block" placeholder="Blurb"><?= h(old('blurb')) ?></textarea>
        ...
        <div class="mb-4">
            ...
            <textarea id="description" name="description" id="description" rows="10" class="form-input form-input-area form-input-block" placeholder="Description"><?= h(old('description')) ?></textarea>
        ...
        <div class="flex-sm">
            ...
            <div class="flex-1 mb-4">
                ...
                <select name="platform_id" id="platformId" class="form-select form-input-block">
                    ...
                    <?php foreach ($platforms as $platform) : ?>
                        <option value="<?= h($platform->id) ?>" <?= $platform->id == old('platform_id') ? 'selected' : '' ?>><?= h($platform->name) ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="flex-1 mb-4 ml-4-sm">
                ...
                <input type="number" name="price" id="price" class="form-input form-input-block form-input--money" step="0.01" min="0" max="999.99" placeholder="Price" value="<?= h(old('price')) ?>">
            ...
            <div class="flex-1 mb-4 ml-4-sm">
                ...
                <input type="date" name="release_date" id="releaseDate" class="form-input form-input-block" placeholder="Release Date" value="<?= h(old('release_date')) ?>">
            ...
            <div class="flex-1 mb-4 ml-4-sm">
                ...
                <select name="rating" id="rating" class="form-select form-input-block">
                    ...
                    <?php for ($i = 1; $i < 6; $i++) : ?>
                        <option value="<?= $i ?>" <?= $i == (old('rating') ?? '5') ? 'selected' : '' ?>><?= $i ?></option>
                    <?php endfor; ?>
                </select>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="trailer" id="trailer" class="form-input form-input-block" placeholder="Trailer embed link" value="<?= h(old('trailer')) ?>">
